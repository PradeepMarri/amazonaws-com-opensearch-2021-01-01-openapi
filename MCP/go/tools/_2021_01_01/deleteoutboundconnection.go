...
func DeleteoutboundconnectionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/2021-01-01/opensearch/cc/outboundConnection/%s", cfg.BaseURL, ConnectionId)
		...
		var result models.DeleteOutboundConnectionResponse
...
func CreateDeleteoutboundconnectionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_2021-01-01_opensearch_cc_outboundConnection_ConnectionId",
		...
		mcp.WithString("ConnectionId", mcp.Required(), mcp.Description("The ID of the outbound connection you want to permanently delete.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeleteoutboundconnectionHandler(cfg),
	}
}
