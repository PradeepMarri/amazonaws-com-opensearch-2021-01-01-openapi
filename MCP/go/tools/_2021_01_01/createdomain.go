...
func CreatedomainHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/2021-01-01/opensearch/domain", cfg.BaseURL)
...
func CreateCreatedomainTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_2021-01-01_opensearch_domain",
		mcp.WithDescription("Creates an Amazon OpenSearch Service domain. For more information, see <a href="https://docs.aws.amazon.com/opensearch-service/latest/developerguide/createupdatedomains.html">Creating and managing Amazon OpenSearch Service domains</a>."),
		...
		mcp.WithObject("LogPublishingOptions", mcp.Description("Input parameter: Key-value pairs to configure log publishing.")),
		...
		mcp.WithArray("TagList", mcp.Description("Input parameter: A list of tags attached to a domain.")),
		...
		mcp.WithObject("AutoTuneOptions", mcp.Description("Input parameter: Options for configuring Auto-Tune. For more information, see <a href=\"https://docs.aws.amazon.com/opensearch-service/latest/developerguide/auto-tune.html\">Auto-Tune for Amazon OpenSearch Service</a> ")),
