...
func CreateDeletedomainTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_2021-01-01_opensearch_domain_DomainName",
		mcp.WithDescription("Deletes an Amazon OpenSearch Service domain and all of its data. You can't recover a domain after you delete it."),
		mcp.WithString("DomainName", mcp.Required(), mcp.Description("The name of the domain you want to permanently delete.")),
	)
