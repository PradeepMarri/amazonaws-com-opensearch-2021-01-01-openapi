...
func ListscheduledactionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/2021-01-01/opensearch/domain/%s/scheduledActions%s", cfg.BaseURL, DomainName, queryString)
		...
		var result models.ListScheduledActionsResponse
...
func CreateListscheduledactionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_2021-01-01_opensearch_domain_DomainName_scheduledActions",
		mcp.WithDescription("Retrieves a list of configuration changes that are scheduled for a domain. These changes can be <a href="https://docs.aws.amazon.com/opensearch-service/latest/developerguide/service-software.html">service software updates</a> or <a href="https://docs.aws.amazon.com/opensearch-service/latest/developerguide/auto-tune.html#auto-tune-types">blue/green Auto-Tune enhancements</a>."),
		...
		mcp.WithString("nextToken", mcp.Description("If your initial <code>ListScheduledActions</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>ListScheduledActions</code> operations, which returns results in the next page.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListscheduledactionsHandler(cfg),
	}
}
