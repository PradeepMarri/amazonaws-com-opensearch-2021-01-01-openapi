# Amazon OpenSearch Service MCP Server

This MCP (Model Content Protocol) server provides access to Amazon OpenSearch Service API functionality through HTTP, HTTPS, and STDIO transport modes.
